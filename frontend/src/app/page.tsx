      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-24">
        ...
        <section className="text-center max-w-4xl flex flex-col items-center">
          ...
          <p className="text-xl md:text-2xl font-bold text-gray-800 mb-12 max-w-2xl leading-relaxed">
            ...
            <span className="bg-[#cfe9ff] px-2 ml-1 border-b-4 border-black">
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-3 border-4 border-black px-10 py-5 text-2xl font-black rounded-2xl
            bg-white shadow-[10px_10px_0px_black] transition-all
        ...
        <section className="mt-32 w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div
                key={feature.title}
                className={`border-4 border-black rounded-[30px] p-8 ${feature.color}
                shadow-[8px_8px_0px_black] transform transition hover:-rotate-1`}>
